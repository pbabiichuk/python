...
for step in range(reverse_timer, -1, -1):
    ready = int(input('Готовы забрать еду? (0 - нет, 1 - да) '))
    if ready == 1:
        print(f'Ваша еда готова, можете забрать, таймер был остановлен на {reverse_timer-step} секунде')
        break
    elif step == 0:
